...
function addProjectToWorkspaceJson(tree, projectName, project, mode, standalone = false) {
    ...
    if (configFile) {
        if (mode === 'delete') {
            ...
            (0, json_1.writeJson)(tree, configFile, Object.assign(Object.assign(Object.assign(Object.assign({}, jsonSchema), { name: mode === 'create' ? projectName : project.name }), project), { root: undefined }));
        }
    }
    else if (mode === 'delete') {
        delete workspaceJson.projects[projectName];
