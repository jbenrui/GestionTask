...
const iosTransitionAnimation = () => Promise.resolve().then(function () { return require('./ios.transition-157b4396.js'); });
const mdTransitionAnimation = () => Promise.resolve().then(function () { return require('./md.transition-44d6757c.js'); });
